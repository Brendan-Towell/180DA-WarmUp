...
while True:
    ...
    if((ACCx - prevACCx) > 5):
        outputString += "push forwards"
    elif((ACCz - prevACCz) > 3):
        outputString += "lift up"
    else:
        outputString += "idle or not one of the given movements"
    prevCFangleY = CFangleY
    prevCFangleX = CFangleX
    prevACCx = ACCx
    prevACCz = ACCz
    print(outputString)
